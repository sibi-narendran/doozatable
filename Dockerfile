...
RUN rm -rf /baserow/web-frontend

# Copy the entire modified web-frontend directory (source + build artifacts + static assets)
COPY --from=frontend-builder --chown=9999:9999 /web-frontend /baserow/web-frontend
